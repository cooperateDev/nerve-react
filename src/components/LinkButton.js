...
export default function LinkButton({ className, text, href }) {
  const buttonContent = (
    <button
      className={`group border-gray-50 hover:border-gray-200 active:border-gray-300 rounded-full focus:ring-0 active:ring-0 focus:outline-none transform-gpu transition duration-500 ease-in-out {className}`}
    >
      <div className="-mt-1">
